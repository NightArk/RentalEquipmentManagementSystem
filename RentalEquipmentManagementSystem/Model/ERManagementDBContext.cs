...
namespace RentalEquipmentManagementSystem.Model;

public partial class ERManagementDBContext : DbContext
{
    public ERManagementDBContext()
    {
    }

    public ERManagementDBContext(DbContextOptions<ERManagementDBContext> options)
        : base(options)
    {
    }
